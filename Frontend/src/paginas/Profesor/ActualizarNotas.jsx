...
export const ActualizarNotas = () => {
    ...
    return (
        <div>
            <h1 className='font-black text-4xl text-gray-500 text-center'>Actualizar Notas</h1>
            <hr className='my-4' />
            <p className='mb-8 text-center'>Este módulo te permite actualizar las notas de los estudiantes</p>
